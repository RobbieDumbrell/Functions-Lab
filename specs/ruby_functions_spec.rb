require('minitest/autorun') #requiring from a gem (external code)
require_relative('../ruby_functions') #requiring from local directory

class FunctionsTest < MiniTest::Test

  # def test_return_10()
  #   return_10_result = return_10()
  #   assert_equal(10, return_10_result) # expecting 10, return_10_result is what code is giving.
  # end
  ...
  #
  #   sphere = volume_of_sphere(2)
  #   assert_equal(33.51, sphere)
  #   #add test code here
  # end
  ...
  def test_fahrenheit_to_celsius()
    ...
    celsius = fahrenheit_to_celsius(33.8)
    assert_equal(1, celsius)
